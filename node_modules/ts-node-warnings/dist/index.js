...
function logDiagnostics(diagnostics, cwd, ts, lineOffset) {
    return diagnostics.forEach(function (x) { return console.log(formatDiagnostic(x, cwd, ts, lineOffset).message); });
}
